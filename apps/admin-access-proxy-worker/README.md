...
2. Set `UPSTREAM_API_ORIGIN` and `PATH_PREFIX` in `wrangler.toml` (or dashboard vars).
...
4. Add a **Route** on your **admin** zone: e.g. `your-admin.com/api/lh-upstream/*` → this Worker.
