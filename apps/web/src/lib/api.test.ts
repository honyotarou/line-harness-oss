...
describe('api object (integration via global fetch)', () => {
  ...
  it('scenarios CRUD and steps', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/scenarios/s1', expect.anything())
    await api.scenarios.create({ name: 'n', lineAccountId: null } as Parameters<typeof api.scenarios.create>[0])
    expect(globalThis.fetch).toHaveBeenCalledWith(
      'http://worker.test/api/scenarios',
      expect.objectContaining({ method: 'POST' }),
    )
    ...
    await api.scenarios.addStep('s1', { offsetMinutes: 0, messageType: 'text', messageContent: 'hi' } as Parameters<
      typeof api.scenarios.addStep
    >[1])
    expect(globalThis.fetch).toHaveBeenCalledWith(
  ...
  it('broadcasts get create update delete send', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/broadcasts/b1', expect.anything())
  ...
  it('users get create update delete link accounts', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/users/u1', expect.anything())
  ...
  it('lineAccounts get create update delete', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/line-accounts/la1', expect.anything())
  ...
  it('affiliates CRUD and report query', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/affiliates', expect.anything())
    await api.affiliates.get('a1')
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/affiliates/a1', expect.anything())
  ...
  it('templates list with category and CRUD', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/templates', expect.anything())
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/templates/t1', expect.anything())
  ...
  it('automations list logs with limit', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/automations', expect.anything())
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/automations/a1', expect.anything())
  ...
  it('chats list get create update send', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/chats/c1', expect.anything())
  ...
  it('reminders CRUD and steps', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/reminders/r1', expect.anything())
    ...
    await api.reminders.addStep('r1', { offsetMinutes: 1, messageType: 'text', messageContent: 'm' })
    expect(globalThis.fetch).toHaveBeenCalledWith(
  ...
  it('scoring rules and friendScore', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/scoring-rules', expect.anything())
    await api.scoring.getRule('sr1')
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/scoring-rules/sr1', expect.anything())
  ...
  it('webhooks incoming and outgoing CRUD', async () => {
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/webhooks/incoming', expect.anything())
    ...
    expect(globalThis.fetch).toHaveBeenCalledWith('http://worker.test/api/webhooks/outgoing', expect.anything())
...
describe('fetchApiCore', () => {
  ...
  it('throws ApiError with status and JSON body on error response', async () => {
    ...
    await expect(
      fetchApiCore('http://x', fetchMock as typeof fetch, '/p'),
