...
const menuSections = [
  {
    ...
    items: [
      ...
      },
      {
        href: '/inbox',
        label: '受信箱',
        icon: 'M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H8a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-1.414 0l-2.414-2.414A1 1 0 0010.586 13H8',
      },
    ],
  },
  {
