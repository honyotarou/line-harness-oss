...
import { denyUnlessLineAccountAtRestKeyForCreates } from '../../src/services/line-account-at-rest-policy.js';
...
describe('denyUnlessLineAccountAtRestKeyForCreates', () => {
  it('returns null for localhost-style Workers (plaintext allowed without key)', async () => {
    const app = new Hono<Env>();
    app.get('/t', (c) => denyUnlessLineAccountAtRestKeyForCreates(c) ?? c.text('ok'));
